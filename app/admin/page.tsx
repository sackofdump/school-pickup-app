        ...
        <div className="grid gap-4">
          ...
          >
            <div className="flex items-center gap-3">
              <span className="text-2xl">🤒</span>
              <div>
                <p className="font-semibold text-gray-800">Absent Today</p>
                <p className="text-gray-500 text-sm">Mark students as sick or absent</p>
              </div>
            </div>
            <span className="text-gray-400">›</span>
          </Link>
          ...
          >
            <div className="flex items-center gap-3">
              <span className="text-2xl">📥</span>
              <div>
                <p className="font-semibold text-gray-800">Bulk Import</p>
                <p className="text-gray-500 text-sm">Import students and parents from a CSV</p>
              </div>
            </div>
            <span className="text-gray-400">›</span>
          </Link>
